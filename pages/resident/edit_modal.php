                ...
                <div class="container-fluid">
                    <div class="col-md-6 col-sm-12">
						...
						<div class="form-group">
							...
							<select name="ddl_dperson" class="form-control input-sm input-size">
							<option value="">Select a Differently-abled Person</option>
                        ...
                        <div class="form-group">
                            <label class="control-label">KVOC Merchant ID:</label>
                                ...
                                <option>Deep Well</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="txt_toilet" class="form-control input-sm input-size">
                                            <option>Village Compliant</option>
                                            <option>Non Village Compliant</option>
                                        </select>
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="ddl_edit_dtype" class="form-control input-sm">
                                <option value="'.$erow['dwellingtype'].'">'.$erow['dwellingtype'].'</option>
                                            <option value="1st Option">Duplex</option>
                                            <option value="2nd Option">Town-House</option>
											<option value="3rd Option">Quadruplex</option>
											<option value="4th Option">Rowhouse</option>
                            </select>
                        </div>
